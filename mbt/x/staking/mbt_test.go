...
func TestTracesLongRandom(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/long.json"))
}

func TestTracesP0(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P0.json"))
}
func TestTracesP1(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P1.json"))
}
func TestTracesP2(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P2.json"))
}
func TestTracesP3(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P3.json"))
}
func TestTracesP4(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P4.json"))
}
func TestTracesP5(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P5.json"))
}
func TestTracesP6(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P6.json"))
}
func TestTracesP7(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P7.json"))
}
func TestTracesP8(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P8.json"))
}
func TestTracesP13(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P13.json"))
}
func TestTracesP14(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P14.json"))
}
func TestTracesP15(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P15.json"))
}
func TestTracesP16(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P16.json"))
}
func TestTracesP17(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P17.json"))
}
func TestTracesP18(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P18.json"))
}
func TestTracesP19(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P19.json"))
}
func TestTracesP20(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P20.json"))
}
func TestTracesP21(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P21.json"))
}
func TestTracesP22(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P22.json"))
}
func TestTracesP23(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P23.json"))
}
func TestTracesP24(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P24.json"))
}
func TestTracesP25(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P25.json"))
}
func TestTracesP26(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P26.json"))
}
func TestTracesP27(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P27.json"))
}
func TestTracesP28(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P28.json"))
}
func TestTracesP29(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P29.json"))
}
func TestTracesP30(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P30.json"))
}
func TestTracesP31(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P31.json"))
}
func TestTracesP32(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P32.json"))
}
func TestTracesP33(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P33.json"))
}
func TestTracesP34(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P34.json"))
}
func TestTracesP35(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P35.json"))
}
func TestTracesP36(t *testing.T) {
	ExecuteTraces(t, loadTraces("traces/P36.json"))
}
